...
import com.nec.corestudy.amf.NamfSdmCLI.model.Ambr;
import com.nec.corestudy.amf.NamfSdmCLI.model.AreaRestriction;
import com.nec.corestudy.amf.NamfSdmCLI.model.Nssai;
...
public class AccessAndMobilitySubscriptionData   {
  ...
  private List<RatType> ratRestriction = null;
  ...
  **/
  ...
  public AccessAndMobilitySubscriptionData ratRestriction(List<RatType> ratRestriction) {
    this.ratRestriction = ratRestriction;
    return this;
  }

  public AccessAndMobilitySubscriptionData addRatRestrictionItem(RatType ratRestrictionItem) {
    if (this.ratRestriction == null) {
      this.ratRestriction = new ArrayList<RatType>();
    }
  ...
  **/
  @ApiModelProperty(value = "")
  public List<RatType> getRatRestriction() {
    return ratRestriction;
  }

  public void setRatRestriction(List<RatType> ratRestriction) {
    this.ratRestriction = ratRestriction;
  }
