package com.nec.corestudy.udm.NudmUECM.common.api.SmsfNon3GppAccessRegistration;
...
@Service
public class SmsfNon3GppAccessRegistrationAccess {

    private static final Logger log = LoggerFactory.getLogger(SmsfNon3GppAccessRegistrationAccess.class);
...
//    public void updateTBL(String key, SmsfRegistrationModificationDB updData) {
    public void updateTBL(String key, SmsfRegistrationDB updData) {   // NoDefine 29503-061
        ...
        udrAccess.setKeyName("ueid");
        udrAccess.setTblName("ContextDataSmsf");
        String insertParameter = "\'{ \"smsfNon3GppAccessRegistration\": { \"smsfId\": " + addQuart(updData.getSmsfId())
            + ", \"supportedFeatures\": " + addQuart(updData.getSupportedFeatures())
            + " }, \"smsf3GppAccessRegistration\": {} }\'";
        String updParameter = "'$.smsfNon3GppAccessRegistration.smsfId', " + addQuart(updData.getSmsfId())
            + ", '$.smsfNon3GppAccessRegistration.supportedFeatures', " + addQuart(updData.getSupportedFeatures());
    ...
    public void deleteTBL(String key) {
        ...
        udrAccess.setKeyName("ueid");
        udrAccess.setTblName("ContextDataSmsf");
        String delParameter = "'$.smsfNon3GppAccessRegistration.smsfId'"
            + ", '$.smsfNon3GppAccessRegistration.supportedFeatures'";
    ...
    public SmsfRegistrationDB getData(String key) {
        ...
        SmsfRegistrationDB smsfRegistration = contextDataSmsf.getSmsfNon3GppAccessRegistration();
