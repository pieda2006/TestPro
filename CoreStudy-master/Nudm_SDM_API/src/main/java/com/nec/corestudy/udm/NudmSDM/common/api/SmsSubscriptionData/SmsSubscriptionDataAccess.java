package com.nec.corestudy.udm.NudmSDM.common.api.SmsSubscriptionData;
...
@Service
public class SmsSubscriptionDataAccess {

    private static final Logger log = LoggerFactory.getLogger(SmsSubscriptionDataAccess.class);
    ...
    public void updateTBL(String key, SmsSubscriptionDataDB updData) {
        log.debug("### updateTBL Start ###");
        log.debug("### Parameter : key : " + key);
        log.debug("### Parameter : SmsSubscriptionData : " + updData);
...
//            + " on duplicate key update SubscriptionData = JSON_SET(SubscriptionData, " + updParameter + ")");
    ...
    public void deleteTBL(String key) {
        ...
        udrAccess.setKeyName("supi");
        udrAccess.setTblName("SubscriptionData");
        String delParameter = "'$.smsSubscriptionData.smsSupported'"
            + ", '$.smsSubscriptionData.smsf3GppAddress'"
            + ", '$.smsSubscriptionData.smsfNon3GppAddress'";
    ...
    public SmsSubscriptionDataDB getData(String key) {
        log.debug("### getData Start ###");
        log.debug("### Parameter : key : " + key);

        // get SmsSubscriptionData from UDR
        String result = selectTBL(key);
        log.debug("result : " + result);
        if(result == null) {
            log.info("SmsSubscriptionData Nothing, key : " + key);
        ...
        SmsSubscriptionDataDB smsSubscriptionData = subscriptionData.getSmsSubscriptionData();
        log.debug("smsSubscriptionData : " + smsSubscriptionData);

        log.debug("### getData End ###");
        return smsSubscriptionData;
    }

    public void setData(String key, SmsSubscriptionDataDB updData) {
        log.debug("### setData Start ###");
        log.debug("### Parameter : key : " + key);
        log.debug("### Parameter : SmsSubscriptionData : " + updData);

        // set SmsSubscriptionData from UDR
    ...
    public void delData(String key) {
        ...
        // del SmsSubscriptionData from UDR
        deleteTBL(key);
