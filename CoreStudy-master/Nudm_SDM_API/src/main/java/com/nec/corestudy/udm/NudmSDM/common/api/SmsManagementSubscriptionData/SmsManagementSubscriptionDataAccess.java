package com.nec.corestudy.udm.NudmSDM.common.api.SmsManagementSubscriptionData;
...
@Service
public class SmsManagementSubscriptionDataAccess {

    private static final Logger log = LoggerFactory.getLogger(SmsManagementSubscriptionDataAccess.class);
    ...
    public void updateTBL(String key, SmsManagementSubscriptionDataDB updData) {
        log.debug("### updateTBL Start ###");
        log.debug("### Parameter : key : " + key);
        log.debug("### Parameter : SmsManagementSubscriptionData : " + updData);
...
//            + " on duplicate key update SubscriptionData = JSON_SET(SubscriptionData, " + updParameter + ")");
    ...
    public void deleteTBL(String key) {
        ...
        udrAccess.setKeyName("supi");
        udrAccess.setTblName("SubscriptionData");
        String delParameter = "'$.smsManagementSubscriptionData.supportedFeatures'"
            + ", '$.smsManagementSubscriptionData.mtSmsSubscribed'"
            + ", '$.smsManagementSubscriptionData.mtSmsBarringAll'"
            + ", '$.smsManagementSubscriptionData.mtSmsbarringRoaming'"
            + ", '$.smsManagementSubscriptionData.moSmsSubscribed'"
            + ", '$.smsManagementSubscriptionData.moSmsBarringAll'"
            + ", '$.smsManagementSubscriptionData.moSmsbarringRoaming'";
    ...
    public SmsManagementSubscriptionDataDB getData(String key) {
        log.debug("### getData Start ###");
        log.debug("### Parameter : key : " + key);

        // get SmsManagementSubscriptionData from UDR
        String result = selectTBL(key);
        log.debug("result : " + result);
        if(result == null) {
            log.info("SmsManagementSubscriptionData Nothing, key : " + key);
        ...
        SmsManagementSubscriptionDataDB smsManagementSubscriptionData = subscriptionData.getSmsManagementSubscriptionData();
        log.debug("smsManagementSubscriptionData : " + smsManagementSubscriptionData);

        log.debug("### getData End ###");
        return smsManagementSubscriptionData;
    }

    public void setData(String key, SmsManagementSubscriptionDataDB updData) {
        log.debug("### setData Start ###");
        log.debug("### Parameter : key : " + key);
        log.debug("### Parameter : SmsManagementSubscriptionData : " + updData);

        // set SmsManagementSubscriptionData from UDR
    ...
    public void delData(String key) {
        ...
        // del SmsManagementSubscriptionData from UDR
        deleteTBL(key);
