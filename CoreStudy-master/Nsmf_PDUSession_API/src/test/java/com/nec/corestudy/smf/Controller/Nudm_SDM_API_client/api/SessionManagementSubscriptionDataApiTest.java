...
/**
 * API tests for SessionManagementSubscriptionDataApi
 */
@Ignore
public class SessionManagementSubscriptionDataApiTest {

    private final SessionManagementSubscriptionDataApi api = new SessionManagementSubscriptionDataApi();
     ...
     */
    @Test
    public void getSmDataTest() throws ApiException {
        String supi = null;
        String supportedFeatures = null;
        String singleNssai = null;
        String dnn = null;
        String plmnId = null;
        List<SessionManagementSubscriptionData> response = api.getSmData(supi, supportedFeatures, singleNssai, dnn, plmnId);
     ...
     */
    @Test
    public void getSmsDataTest() throws ApiException {
        String supi = null;
        SmsSubscriptionData response = api.getSmsData(supi);
