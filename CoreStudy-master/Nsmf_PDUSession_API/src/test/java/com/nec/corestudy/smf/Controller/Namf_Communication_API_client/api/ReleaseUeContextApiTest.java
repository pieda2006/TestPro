...
/**
 * API tests for ReleaseUeContextApi
 */
@Ignore
public class ReleaseUeContextApiTest {

    private final ReleaseUeContextApi api = new ReleaseUeContextApi();
     ...
     */
    @Test
    public void postReleaseUEContextTest() throws ApiException {
        String ueContextId = null;
        AMFUEContextRelease uEContextRelease = null;
        api.postReleaseUEContext(ueContextId, uEContextRelease);
