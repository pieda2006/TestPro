 ...
 */
@JsonAdapter(PduSessionType.Adapter.class)
public enum PduSessionType {
  ...
  public static class Adapter extends TypeAdapter<PduSessionType> {
    @Override
    public void write(final JsonWriter jsonWriter, final PduSessionType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PduSessionType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PduSessionType.fromValue(String.valueOf(value));
    }
  }
}
