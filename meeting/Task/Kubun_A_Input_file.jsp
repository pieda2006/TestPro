...
if(isFile == 0){
db.exeQuery("update " + ClassDefine.query + " set username = '" + user + "',date = '" + day + "', kubun = " + new_row + ", check1 =  " + tag + ", check2 =  " + sercret + ", check3 = " + check3 + "where no = " + no + ";");
}
else if(isFile == 1){
db.exeQuery("update " + ClassDefine.query + " set username = '" + user + "',date = '" + day + "', file = '" + file + "', kubun = " + new_row + ", check1 =  " + tag + ", check2 =  " + sercret + ", check3 = " + check3 + "  where no = " + no + ";");
}
}
