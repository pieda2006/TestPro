...
if(request.getParameter("update_topic_id") != null && !request.getParameter("update_topic_id").equals("")){
    Date updatestartdate = sdf2.parse(search_word_20);
    Calendar cal3 = Calendar.getInstance();
    cal3.setTime(updatestartdate);
    String update_kind = request.getParameter("update_kind");
    int updateshinchoku = 0;
    long updatetime = 0;
    Date startdate = null;
    Date enddate = null;
    String upusrname = null;
    int update_topic_id = Integer.parseInt(request.getParameter("update_topic_id"));

    String new_planvalue = null;
    String old_planvalue = null;
    String bikovalue = "";

    if(request.getParameter("update_kind").equals("report")){
        db.getQuery("select * from " + ClassDefine.topic_report + " where id = " + update_topic_id + "order by date;");
    } else {
        db.getQuery("select * from " + ClassDefine.topic_plan + " where id = " + update_topic_id + "order by date;");
    }
    db.getNext();
    boolean updateflg = false;
    for(int count = 0; count <= Integer.parseInt(request.getParameter("update_counter")); count++){
        new_planvalue = request.getParameter("plan[" + count + "]");
        old_planvalue = request.getParameter("old_plan[" + count + "]");

        if(!new_planvalue.equals(old_planvalue) && !old_planvalue.equals("") && !new_planvalue.equals("")){
            do {
        	    if(cal3.getTime().equals(sdf2.parse(dayop.editDate(db.getResult("date").substring(0,10))))){
                    //進捗と工数を加算
                    startdate = sdf1.parse(dayop.editDate(db.getResult("date")));
                    enddate = sdf1.parse(dayop.editDate(db.getResult("complete_date")));
                    // 日付をlong値に変換します。
                    // 差分の日数を算出します。
                    updatetime =  updatetime + ( enddate.getTime() - startdate.getTime()  ) / (1000 * 60);
                    updateshinchoku = updateshinchoku + Integer.parseInt(db.getResult("shinchoku"));
                    bikovalue = bikovalue + db.getResult("biko");
                    updateflg = true;
                    upusrname = db.getResult("user_name");
                } else if(cal3.getTime().before(sdf2.parse(dayop.editDate(db.getResult("date").substring(0,10))))){
                    break;
                }
            } while (db.getNext());
            if(updateflg) {
                    if(request.getParameter("update_kind").equals("report")){
                    	...
                    	if(search_word_23.equals("0")){
                	        topic_db.exeQuery("delete from " + ClassDefine.topic_report + " where id = " + update_topic_id + " and '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " 00:00:00' <= date and date < '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + (cal3.get(Calendar.DATE)) + " 24:00:00'");
                            topic_db.exeQuery("insert into " + ClassDefine.topic_report + " values('" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " 01:00:00', '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " " + ((updatetime/60) + 1) + ":" + updatetime%60 + "'," + update_topic_id + ",'" + upusrname + "','" + bikovalue + "'," + new_planvalue + ")");
                        } else if(search_word_23.equals("1")){
                	        topic_db.exeQuery("delete from " + ClassDefine.topic_report + " where id = " + update_topic_id + " and '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " 00:00:00' <= date and date < '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + (cal3.get(Calendar.DATE)) + " 24:00:00'");
                            topic_db.exeQuery("insert into " + ClassDefine.topic_report + " values('" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " 01:00:00', '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " " + (((Integer.parseInt(new_planvalue))/60) + 1) + ":" + (Integer.parseInt(new_planvalue))%60 + "'," + update_topic_id + ",'" + upusrname + "','" + bikovalue + "'," + updateshinchoku + ")");
                        }
                    } else {
                    	if(search_word_23.equals("0")){
                	        topic_db.exeQuery("delete from " + ClassDefine.topic_plan + " where id = " + update_topic_id + " and '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " 00:00:00' <= date and date < '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + (cal3.get(Calendar.DATE)) + " 24:00:00'");
                            topic_db.exeQuery("insert into " + ClassDefine.topic_plan + " values('" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " 01:00:00', '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " " + ((updatetime/60) + 1) + ":" + updatetime%60 + "'," + update_topic_id + ",'" + upusrname + "','" + bikovalue + "'," + new_planvalue + ")");
                        } else if(search_word_23.equals("1")){
                	        topic_db.exeQuery("delete from " + ClassDefine.topic_plan + " where id = " + update_topic_id + " and '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " 00:00:00' <= date and date < '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + (cal3.get(Calendar.DATE)) + " 24:00:00'");
                            topic_db.exeQuery("insert into " + ClassDefine.topic_plan + " values('" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " 01:00:00', '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " " + ((Integer.parseInt(new_planvalue))/60 + 1) + ":" + (Integer.parseInt(new_planvalue))%60 + "'," + update_topic_id + ",'" + upusrname + "','" + bikovalue + "'," + updateshinchoku + ")");
                        }
                    }
                    updatetime = 0;
                    updateshinchoku = 0;
        ...
        } else if(!new_planvalue.equals(old_planvalue) && old_planvalue.equals("")){
        	//Oldが空文字なのでインサート
        	user_db.getQuery("select user_id from " + ClassDefine.topic_info + " where topic_id = " + update_topic_id);
        	user_db.getNext();
        	                    if(request.getParameter("update_kind").equals("report")){
                    	if(search_word_23.equals("0")){
                            topic_db.exeQuery("insert into " + ClassDefine.topic_report + " values('" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " 01:00:00', '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " " + ((updatetime/60) + 1) + ":" + updatetime%60 + "'," + update_topic_id + ",'" + user_db.getResult("user_id") + "','" + bikovalue + "'," + new_planvalue + ")");
                        } else if(search_word_23.equals("1")){
                            topic_db.exeQuery("insert into " + ClassDefine.topic_report + " values('" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " 01:00:00', '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " " + (((Integer.parseInt(new_planvalue))/60) + 1) + ":" + (Integer.parseInt(new_planvalue))%60 + "'," + update_topic_id + ",'" + user_db.getResult("user_id") + "','" + bikovalue + "'," + updateshinchoku + ")");
                        }
                    } else {
                    	if(search_word_23.equals("0")){
                            topic_db.exeQuery("insert into " + ClassDefine.topic_plan + " values('" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " 01:00:00', '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " " + ((updatetime/60) + 1) + ":" + updatetime%60 + "'," + update_topic_id + ",'" + user_db.getResult("user_id") + "','" + bikovalue + "'," + new_planvalue + ")");
                        } else if(search_word_23.equals("1")){
                            topic_db.exeQuery("insert into " + ClassDefine.topic_plan + " values('" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " 01:00:00', '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " " + (((Integer.parseInt(new_planvalue))/60) + 1) + ":" + (Integer.parseInt(new_planvalue))%60 + "'," + update_topic_id + ",'" + user_db.getResult("user_id") + "','" + bikovalue + "'," + updateshinchoku + ")");
                        }
                    }
        } else if(!new_planvalue.equals(old_planvalue) && new_planvalue.equals("")){
        	//Newが空文字なのでデリート
        	    if(request.getParameter("update_kind").equals("report")){
                	        topic_db.exeQuery("delete from " + ClassDefine.topic_report + " where id = " + update_topic_id + " and '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " 00:00:00' <= date and date < '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + (cal3.get(Calendar.DATE)) + " 24:00:00'");
                    } else {
...
<form id=formid action="update-plan-report-Page.jsp" method="post">
<SCRIPT><!--
...
<%
} else if(search_word_26.equals("3")){
%>   
<option value="3">With in period</option>
<%
}
%>
<option value="0">含まない</option>
...
<a href="select-plan-report-Page.jsp"><font size=2 color="black">表示用ページ</font></a><br><br>
<%
/*
...
if (search_word_26 == null || !search_word_26.equals("3")){
db.getQuery("select topic_id,user_id,topic_sub_id,kind_id,kouban,plan_topic_date,plan_limit_date from " + ClassDefine.topic_info + " order by kouban,kind_id,topic_sub_id,plan_limit_date,topic_id;");
} else {
db.getQuery("select topic_id,user_id,topic_sub_id,kind_id,kouban,plan_topic_date,plan_limit_date from " + ClassDefine.topic_info + " where plan_topic_date <= '" + search_word_22 + "' and '" + search_word_20 + "' <= plan_limit_date order by kouban,kind_id,topic_sub_id,plan_limit_date,topic_id;");
}
...
if(((search_word_26 == null || search_word_26.equals("0")) && topic2_db.getResult("topic_delete").equals("0")) ||
    (search_word_26.equals("3") && topic2_db.getResult("topic_delete").equals("0")) || 
...
while(topic_db.getNext()){
    if(tempcompdate.equals("")){
        ...
        if(search_word_23.equals("0")){
            ...
            // 差分の日数を算出します。
            tempshinchoku = ( dateTimeTo - dateTimeFrom  ) / (1000 * 60);
            addshinchoku = addshinchoku + ( dateTimeTo - dateTimeFrom  ) / (1000 * 60);
        }
        continue;
        ...
        if(search_word_23.equals("0")){
            ...
            dateTimeTo = dateTo.getTime();
            dateTimeFrom = dateFrom2.getTime();
            tempshinchoku = tempshinchoku + ( dateTimeTo - dateTimeFrom  ) / (1000 * 60);
            addshinchoku = addshinchoku + ( dateTimeTo - dateTimeFrom  ) / (1000 * 60);
        }
        continue;
    }
        ...
        if(cal2.getTime().equals(sdf2.parse(dayop.editDate(tempcompdate)))){
            %>
                <td nowrap bgcolor="blue">
                    <input type="text" name="plan[<%= daycounter%>]" value="<%= tempshinchoku%>" size="1" maxlength="30" style="color:#ffffff;background-color:#0000ff;">
                    <input type="hidden" name="old_plan[<%= daycounter%>]" value="<%= tempshinchoku%>">
                </FONT></td>
            <%
               ...
               (cal2.getTime().equals(endDate) || cal2.getTime().before(endDate))){
                %>
                    <td nowrap bgcolor="#00FFFF">
                        <input type="text" name="plan[<%= daycounter%>]" value="" size="1" maxlength="30" style="background-color:#00ffff;">
                        <input type="hidden" name="old_plan[<%= daycounter%>]" value="">
                    </td>
                <%
            } else {
                %>
                    <td nowrap>
                        <input type="text" name="plan[<%= daycounter%>]" value="" size="1" maxlength="30">
                        <input type="hidden" name="old_plan[<%= daycounter%>]" value="">
                    </td>
                <%
            }
...
%>
<td><%= addshinchoku%></td>
<td nowrap><input type="hidden" name="update_kind" value="plan"><input type="hidden" name="update_counter" value="<%= dayDiff%>"><input type="hidden" name="update_topic_id" value="<%= db.getResult("topic_id")%>"><input type="submit" value="変更">  <input type="reset" value="リセット"></td>
</tr>
</form>
<form>
<tr>
...
if(cal2.getTime().equals(sdf2.parse(dayop.editDate(tempcompdate)))){
%>
<td nowrap bgcolor="blue"><FONT color="white">
<input type="text" name="plan[<%= daycounter%>]" value="<%= tempshinchoku%>" size="1" maxlength="30" style="color:#ffffff;background-color:#0000ff;">
<input type="hidden" name="old_plan[<%= daycounter%>]" value="<%= tempshinchoku%>">
</FONT></td>
<%
...
%>
<td><%= addshinchoku%></td>
<td nowrap><input type="hidden" name="update_kind" value="report"><input type="hidden" name="update_counter" value="<%= dayDiff%>"><input type="hidden" name="update_topic_id" value="<%= db.getResult("topic_id")%>"><input type="submit" value="変更">  <input type="reset" value="リセット"></td>
</tr>
</form>
<%
}
