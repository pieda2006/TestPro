...
String calender = (String)session.getAttribute("calender1");//表示範囲
...
<body>
<center>
<a href="select-plan-Page.jsp"><font size=2 color="black">作業予定表示画面</font></a>
...
<TD><FONT COLOR="Crimson">カレンダー：</FONT>
</TD>
...
<TR><TD align="center" colspan=15><input type="submit" value="検索">  <input type="reset" value="抽出条件リセット"></TD>
</TR></TABLE>
</form>
