...
private static final String TITLE          = "53"; // タイトル
...
private static final String LOG_FILE       = "htbbsf53.log"; // ログファイル名
private static final String COUNT_FILE     = "count53.dat"; // 記事番号保存ファイル
private static final boolean PAST_LOG      = true; // 過去ログ機能：true　あり :false なし
private static final String PAST_DIR       = "past53"; // 過去ログを保存するフォルダ名
private static final String PAST_COUNT     = "pastcount53.dat"; // 過去ログカウントファイル名
...
// ファイルアップロード関連の設定
private static final String FILE_DIR       = "53"; // アップロードしたファイルを保存するフォルダ
