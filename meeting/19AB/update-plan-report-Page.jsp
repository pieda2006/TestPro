        ...
        if(!new_planvalue.equals(old_planvalue) && !old_planvalue.equals("") && !new_planvalue.equals("")){
            ...
            if(updateflg) {
                    if(request.getParameter("update_kind").equals("report")){
                    	...
                    	if(search_word_23.equals("0")){
                	        ...
                	        topic_db.exeQuery("delete from " + ClassDefine.topic_report + " where id = " + update_topic_id + " and '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " 00:00:00' <= date and date < '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + (cal3.get(Calendar.DATE)) + " 24:00:00'");
                            topic_db.exeQuery("insert into " + ClassDefine.topic_report + " values('" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " 01:00:00', '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " " + (((Integer.parseInt(new_planvalue)*15)/60) + 1) + ":" + (Integer.parseInt(new_planvalue)*15)%60 + "'," + update_topic_id + ",'" + upusrname + "','" + bikovalue + "'," + updateshinchoku + ")");
                        }
                    } else {
                    	if(search_word_23.equals("0")){
                	        ...
                	        topic_db.exeQuery("delete from " + ClassDefine.topic_plan + " where id = " + update_topic_id + " and '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " 00:00:00' <= date and date < '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + (cal3.get(Calendar.DATE)) + " 24:00:00'");
                            topic_db.exeQuery("insert into " + ClassDefine.topic_plan + " values('" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " 01:00:00', '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " " + ((Integer.parseInt(new_planvalue)*15)/60 + 1) + ":" + (Integer.parseInt(new_planvalue)*15)%60 + "'," + update_topic_id + ",'" + upusrname + "','" + bikovalue + "'," + updateshinchoku + ")");
                        }
                    }
                    updatetime = 0;
                    updateshinchoku = 0;
        	...
        	user_db.getNext();
                    	...
                    	if(search_word_23.equals("0")){
                            ...
                            topic_db.exeQuery("insert into " + ClassDefine.topic_report + " values('" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " 01:00:00', '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " " + (((Integer.parseInt(new_planvalue)*15)/60) + 1) + ":" + (Integer.parseInt(new_planvalue)*15)%60 + "'," + update_topic_id + ",'" + user_db.getResult("user_id") + "','" + bikovalue + "'," + updateshinchoku + ")");
                        }
                    } else {
                    	if(search_word_23.equals("0")){
                            ...
                            topic_db.exeQuery("insert into " + ClassDefine.topic_plan + " values('" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " 01:00:00', '" + cal3.get(Calendar.YEAR) + "-" + (cal3.get(Calendar.MONTH) + 1) + "-" + cal3.get(Calendar.DATE) + " " + (((Integer.parseInt(new_planvalue)*15)/60) + 1) + ":" + (Integer.parseInt(new_planvalue)*15)%60 + "'," + update_topic_id + ",'" + user_db.getResult("user_id") + "','" + bikovalue + "'," + updateshinchoku + ")");
                        }
                    }
...
*/
db.getQuery("select topic_id,user_id,topic_sub_id,kind_id,state_id,kouban,plan_topic_date,plan_limit_date from " + ClassDefine.topic_info + " order by kouban,kind_id,topic_sub_id,plan_limit_date,topic_id;");
...
<form>
<%
  if(db.getResult("state_id").equals("2")){
%>
    <tr bgcolor="#808080">
<%
  } else {
...
<td nowrap rowspan=2><%= db.getResult("topic_id")%></td>
<%
