...
<body>
<form id=formid action="createuser_result.jsp" method="post">
ユーザID：
<input type="text" name="user_name" value="" size="3" maxlength="30">
名前：
<input type="text" name="user_namejp" value="" size="3" maxlength="30">
パスワード：
<input type="text" name="user_pass" value="" size="3" maxlength="30">
