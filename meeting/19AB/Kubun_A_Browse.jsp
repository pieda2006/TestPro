...
<form action="Input-tag-Page.jsp" method="post" style="display: inline">登録件数：<input name="kensu" type="text" value="" size="5"><input type="submit" value="タグ登録"></form>
<FONT COLOR="Crimson">
...
<a href="Kubun_A_Browse_View.jsp"><font size=2 color="black">表示用</font></a>
<%
int num = 0;//データの個数
%>
...
<td align="center" nowrap bgcolor="#e8e8e8">日付</td>
<td align="center" nowrap bgcolor="#e8e8e8">概要</td>
<td align="center" nowrap bgcolor="#e8e8e8">ディレクトリ</td>
<td align="center" nowrap bgcolor="#e8e8e8">表示設定</td>
<td align="center" nowrap bgcolor="#e8e8e8">ロック</td>
<td align="center" nowrap bgcolor="#e8e8e8">delete</td>
<td align="center" nowrap bgcolor="#e8e8e8">File</td>
<td align="center" nowrap bgcolor="#e8e8e8">履歴数</td>
<td align="center" nowrap bgcolor="#e8e8e8">送信ファイル</td>
<td align="center" nowrap width="100" bgcolor="#e8e8e8">更新</td>
</tr>
<tr>
<form action="Kubun_A_Input.jsp" enctype="multipart/form-data" method="post">
...
<td nowrap><input type="submit" value="送信" nowrap><input type="reset" value="リセット"></td>
</form>
</tr>
<%
tag_db.getQuery("select * from " + ClassDefine.tag + " where full_dir = '" + search_word_9 + "';");
...
user_db.getQuery("select name from userpass where username='" + db.getResult("username") + "';");
user_db.getNext();
%>
<option value="1"><%= user_db.getResult("name")%></option>
<option value="0">ロック解除</option>
<%
}
else {
%>
...
if(!db.getResult("username").equals("dummy")){
%>
<td nowrap><input type="submit" value="登録"><input type="reset" value="リセット"></td>
<%
} else{
%>
<td nowrap><input type="submit" value="ロック"><input type="reset" value="リセット"></td>
<%
}
%>
</form>
