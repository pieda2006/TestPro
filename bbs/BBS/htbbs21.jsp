...
private static final String TITLE          = "21"; // タイトル
...
private static final String LOG_FILE       = "htbbsf21.log"; // ログファイル名
private static final String COUNT_FILE     = "count21.dat"; // 記事番号保存ファイル
private static final boolean PAST_LOG      = true; // 過去ログ機能：true　あり :false なし
private static final String PAST_DIR       = "past21"; // 過去ログを保存するフォルダ名
private static final String PAST_COUNT     = "pastcount21.dat"; // 過去ログカウントファイル名
...
// ファイルアップロード関連の設定
private static final String FILE_DIR       = "21"; // アップロードしたファイルを保存するフォルダ
