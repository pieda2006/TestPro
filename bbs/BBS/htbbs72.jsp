...
private static final String TITLE          = "72"; // タイトル
...
private static final String LOG_FILE       = "htbbsf72.log"; // ログファイル名
private static final String COUNT_FILE     = "count72.dat"; // 記事番号保存ファイル
private static final boolean PAST_LOG      = true; // 過去ログ機能：true　あり :false なし
private static final String PAST_DIR       = "past72"; // 過去ログを保存するフォルダ名
private static final String PAST_COUNT     = "pastcount72.dat"; // 過去ログカウントファイル名
...
// ファイルアップロード関連の設定
private static final String FILE_DIR       = "72"; // アップロードしたファイルを保存するフォルダ
