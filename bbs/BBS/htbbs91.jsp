...
private static final String TITLE          = "91"; // タイトル
...
private static final String LOG_FILE       = "htbbsf91.log"; // ログファイル名
private static final String COUNT_FILE     = "count91.dat"; // 記事番号保存ファイル
private static final boolean PAST_LOG      = true; // 過去ログ機能：true　あり :false なし
private static final String PAST_DIR       = "past91"; // 過去ログを保存するフォルダ名
private static final String PAST_COUNT     = "pastcount91.dat"; // 過去ログカウントファイル名
...
// ファイルアップロード関連の設定
private static final String FILE_DIR       = "91"; // アップロードしたファイルを保存するフォルダ
