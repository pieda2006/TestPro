...
private static final String TITLE          = "38"; // タイトル
...
private static final String LOG_FILE       = "htbbsf38.log"; // ログファイル名
private static final String COUNT_FILE     = "count38.dat"; // 記事番号保存ファイル
private static final boolean PAST_LOG      = true; // 過去ログ機能：true　あり :false なし
private static final String PAST_DIR       = "past38"; // 過去ログを保存するフォルダ名
private static final String PAST_COUNT     = "pastcount38.dat"; // 過去ログカウントファイル名
...
// ファイルアップロード関連の設定
private static final String FILE_DIR       = "38"; // アップロードしたファイルを保存するフォルダ
