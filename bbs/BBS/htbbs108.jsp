...
private static final String TITLE          = "108"; // タイトル
...
private static final String LOG_FILE       = "htbbsf108.log"; // ログファイル名
private static final String COUNT_FILE     = "count108.dat"; // 記事番号保存ファイル
private static final boolean PAST_LOG      = true; // 過去ログ機能：true　あり :false なし
private static final String PAST_DIR       = "past108"; // 過去ログを保存するフォルダ名
private static final String PAST_COUNT     = "pastcount108.dat"; // 過去ログカウントファイル名
...
// ファイルアップロード関連の設定
private static final String FILE_DIR       = "108"; // アップロードしたファイルを保存するフォルダ
